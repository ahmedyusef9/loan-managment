...
function Button(props) {
  ...
  return (
    <button className={`${baseStyle} ${props.className || ""}`} {...props}>
      {props.children}
    </button>
  );
}
...
function Input(props) {
  return <input className="input-field mb-3" {...props} />;
}
...
function SelectContent(props) {
  return (
    <div
      className="absolute z-10 w-full mt-1 border border-gray-300 p-2 rounded-md bg-white shadow-lg"
      {...props}
    >
      {props.children}
    </div>
    ...
    async function detectCountry() {
      try {
        ...
        if (country === "IL") {
          ...
          ["AE", "SA", "EG", "IQ", "JO", "KW", "LB", "OM", "QA", "SY"].includes(
            country,
          )
        ) {
          setLang("ar");
        ...
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center bg-white bg-opacity-20 rounded-lg p-2">
            ...
            >
              ...
              <option value="he" className="text-gray-800 bg-white">
                עברית
              </option>
          ...
          <Card className="lg:col-span-1">
            ...
            <CardContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="fixedInterest">
                    {t("fixedInterestLabel")}
                  </Label>
                  <Input
                    id="fixedInterest"
                    type="number"
              ...
              {loans.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-10 text-center">
                  ...
                  <p className="text-gray-400 mt-2">
                    Add your first loan using the form on the left.
                  </p>
                </div>
              ) : (
                        ...
                        <CardContent>
                          <div className="grid grid-cols-2 gap-4 mb-4">
                            ...
                            <div className="stat-card">
                              ...
                              <p className="text-xl font-bold">
                                {loan.fixedInterest + loan.primeRate}%
                              </p>
                              <div className="flex text-xs text-gray-500 mt-1">
                                <span className="mr-2">
                                  {loan.fixedInterest}% {t("fixed")}
                                </span>
                                <span>
                                  {loan.primeRate}% {t("prime")}
                                </span>
                              </div>
                            </div>
                            <div className="stat-card">
